...
if ( ! function_exists( 'amor_pagination' ) ) {
	/**
	 ...
	 */
	function amor_pagination( $args = array(), $class = 'pagination' ) {
		...
		$args = wp_parse_args(
			...
			array(
				'mid_size'           => 2,
				'prev_next'          => true,
				'prev_text'          => __( '&laquo;', 'amor' ),
				'next_text'          => __( '&raquo;', 'amor' ),
				'type'               => 'array',
				'current'            => max( 1, get_query_var( 'paged' ) ),
				'screen_reader_text' => __( 'Posts navigation', 'amor' ),
			)
		);
